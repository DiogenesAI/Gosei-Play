import { Board, Position, Stone, StoneColor, GameState } from '../types/go';
...
export const applyGoRules = (
  ...
  if (color === 'black') {
    // Black just played and captured white stones
    updatedCapturedStones.capturedByBlack += capturedCount;
  } else if (color === 'white') {
    // White just played and captured black stones
    updatedCapturedStones.capturedByWhite += capturedCount;
  }
