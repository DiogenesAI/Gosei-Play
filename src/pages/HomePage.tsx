...
import DirectAISelector from '../components/DirectAISelector';
...
const STORAGE_KEYS = {
  ...
  SELECTED_NETWORK_ID: 'gosei-selected-network-id'
};
...
const HomePage: React.FC = () => {
  ...
  const [gameOptions, setGameOptions] = useState<GameOptions>({
    ...
    selectedNetworkId: getStoredValue(STORAGE_KEYS.SELECTED_NETWORK_ID, null),
  });
  ...
  useEffect(() => {
    ...
    setStoredValue(STORAGE_KEYS.SELECTED_NETWORK_ID, gameOptions.selectedNetworkId);
  }, [gameOptions]);
      ...
      <footer className="bg-white border-t border-neutral-200 py-6 mt-auto">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm text-neutral-600">
            Powered by{' '}
            <a 
              href="https://diogenes.foundation" 
              target="_blank" 
              rel="noopener noreferrer"
