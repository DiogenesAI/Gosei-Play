...
const MobilePlayerPanel: React.FC<MobilePlayerPanelProps> = ({
  ...
  const { players, currentTurn, capturedStones } = gameState;
  ...
  return (
    <div className="w-full bg-white rounded-lg shadow-lg border border-neutral-200 p-3 mb-4">
      ...
      <div className="flex items-center justify-between">
        {/* Black Player */}
        <div className={`flex items-center flex-1 min-w-0 p-2 rounded-lg transition-all duration-200 ${currentTurn === 'black' ? 'bg-neutral-100 ring-2 ring-blue-500' : 'bg-neutral-50'
          }`}>
          ...
          <div className="flex-1 min-w-0 text-center">
            ...
            {showTimer && (
              <>
                <div className={`font-mono font-bold ${isMobile ? 'text-2xl' : 'text-3xl'} ${blackTimeDisplay.isWarning ? 'text-red-600' : 'text-orange-600'
                  }`}>
        ...
        {/* White Player */}
        <div className={`flex items-center flex-1 min-w-0 p-2 rounded-lg transition-all duration-200 ${currentTurn === 'white' ? 'bg-neutral-100 ring-2 ring-blue-500' : 'bg-neutral-50'
          }`}>
          <div className="flex flex-col items-center mr-3">
            <PlayerAvatar
          ...
          <div className="flex-1 min-w-0 text-center">
            ...
            {showTimer && (
              <>
                <div className={`font-mono font-bold ${isMobile ? 'text-2xl' : 'text-3xl'} ${whiteTimeDisplay.isWarning ? 'text-red-600' : 'text-orange-600'
                  }`}>
