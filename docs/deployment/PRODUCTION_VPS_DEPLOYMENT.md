...
**Domain**: gosei-svr01.ecreative.asia  
...
```bash
# Enable the site
sudo ln -s /etc/nginx/sites-available/gosei-svr01.ecreative.asia /etc/nginx/sites-enabled/
...
sudo certbot --nginx -d gosei-svr01.ecreative.asia
...
HEALTH_URL="https://gosei-svr01.ecreative.asia/health"
...
curl -I https://gosei-svr01.ecreative.asia/health
```
...
ab -n 1000 -c 50 https://gosei-svr01.ecreative.asia/
