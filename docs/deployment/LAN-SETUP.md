...
1. Start the server:
   ...
   npm start
   ```
2. Open a new terminal and start the client in LAN mode:
   ```bash
   npm run start:lan
   ```
3. The command output will display your local IP address
4. Other players can access the game at `http://YOUR_IP:3000`
